//Wizard^^ last update 25th August 2013 - adding support for SNARC 1.2 pin change for MOSFET from D14 to D4
...
IPAddress gateway(192,168,0,254); // <-- network gateway IP is put here.
